<div id="s2_stripe_upgrade" class="s2_stripe_form_container">
	<form class="s2_stripe_form">
		
		<p>You are currently member of <?php echo S2MEMBER_CURRENT_USER_ACCESS_LABEL ?>. Want to upgrade?</p>
		<p>First, select your desired plan:</p>
		<div class="row">
		...
		<div class="row">
			<a href="#" class="s2_stripe_pay_button"><?php echo $label ?> <img class="s2_stripe_preloader" src="<?php echo S2_Stripe::get_plugin_url() ?>assets/images/preloader.gif" alt=""></a>
		</div>
	</form>
...
<script>
	...
	jQuery(document).ready(function($){
		...
		var $container = $('#s2_stripe_upgrade');
